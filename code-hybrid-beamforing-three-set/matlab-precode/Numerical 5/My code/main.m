...
for sample=1:num_test
    ...
    [w_rf_block,w_rf, f_rf] = RF_Precoding(H,num_users,user_num_an,bs_num_an,num_user_stream,num_user_rf, bs_num_rf,num_iter, norm_f_rf, norm_w_rf);
    [f_bb, lamda, sigma_all] = FBB_Precoding(H,num_users,user_num_an,bs_num_an,num_user_stream,bs_num_rf,num_user_rf, w_rf,f_rf,P_max,sigma_dB, norm_frf_fbb);
