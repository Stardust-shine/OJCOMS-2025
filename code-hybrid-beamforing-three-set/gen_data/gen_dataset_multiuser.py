...
def generate_H_dataset(number, K, N_r, N, Ncl, Nray):
    ...
    sio.savemat(parent_path + "/data/setH_K" + str(K) + "_N" + str(N_r) + "X"+ str(N) + "_Ncl" + str(Ncl) + "_Nray" + str(Nray) + "_number" + str(number) + ".mat",
                {'H': H})
    print('generated')
    return H
...
if __name__ == '__main__':
    ...
    Nray = 10
    # need a 'data' folder
    generate_H_dataset(500000, K, N_r, Nt, Ncl=Ncl, Nray=Nray)
