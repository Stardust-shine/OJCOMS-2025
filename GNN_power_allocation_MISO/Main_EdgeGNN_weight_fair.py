...
# =================================================================================== #
weight = tf.square(tf.matrix_diag_part(x_1[:, :, :, 0]))
weight = tf.div(1., tf.abs(tf.log(weight * p_pico / var_noise)) / tf.log(2.))
...
with tf.Session(config=tf.ConfigProto(gpu_options=gpu_options)) as sess:
    ...
    for epoch in range(MAX_EPOCHS):
        ...
        if epoch % 1 == 0:
            ...
            weight_test = sess.run(weight, feed_dict={x_1: X_1_test, x_2: X_2_test, x_3: X_3_test,
                                                      index_1: Index_1_test, index_2: Index_2_test,
    ...
    #     start = time.time()
    #     Y_BS_pred_test = sess.run(y_ue_pred,
    #                               feed_dict={x_1: X_1_test[i:i + 1], x_2: X_2_test[i:i + 1], x_3: X_3_test[i:i + 1],
    #                                          index_1: Index_1_test[i:i + 1], index_2: Index_2_test[i:i + 1],
    #                                          index_3: Index_3_test[i:i + 1], a_bs_ue: A_BS_UE_test[i:i + 1]}) \
    #                      * Z_UE_test[i:i + 1]
