import numpy as np
from powerallocation_wmmse import gen_sample,gen_pathloss
import json
import scipy.io as sio

Configfile = open('Config.json', 'r', encoding='utf8')
...
A_BS_UE, X_BS, X_UE, Y_BS, SR, SR_UE, X_D = gen_sample(N_TRAIN, nUE_BS, nTX_BS, p_BS, var_noise, config)
A_BS_UE_test, X_BS_test, X_UE_test, Y_BS_test, SR_test, SR_UE_test, X_D_test \
                              = gen_sample(N_TEST, nUE_BS, nTX_BS, p_BS, var_noise, config)
