...
hx_bs_1 = gnn_pe_layer(x_bs, n_hidden[0], a_bs_ue, x_ue, access_UE_BS, transfer_function=activation_function, name='l1')
hx_ue_1 = gnn_pe_layer(x_ue, n_hidden[0], tf.transpose(a_bs_ue, perm=[0, 2, 1, 3]),
                       x_bs, access_BS_UE, transfer_function=activation_function, name='l1')

hx_bs_2 = gnn_pe_layer(hx_bs_1, n_hidden[1], a_bs_ue, hx_ue_1, access_UE_BS, transfer_function=activation_function, name='l2')
hx_ue_2 = gnn_pe_layer(hx_ue_1, n_hidden[1], tf.transpose(a_bs_ue, perm=[0, 2, 1, 3]),
                       hx_bs_1, access_BS_UE, transfer_function=activation_function, name='l2')

hx_bs_3 = gnn_pe_layer(hx_bs_2, n_hidden[2], a_bs_ue, hx_ue_2, access_UE_BS, transfer_function=activation_function, name='l3')
hx_ue_3 = gnn_pe_layer(hx_ue_2, n_hidden[2], tf.transpose(a_bs_ue, perm=[0, 2, 1, 3]),
                       hx_bs_2, access_BS_UE, transfer_function=activation_function, name='l3')

hx_bs_4 = gnn_pe_layer(hx_bs_3, n_hidden[3], a_bs_ue, hx_ue_3, access_UE_BS, transfer_function=activation_function, name='l4')
hx_ue_4 = gnn_pe_layer(hx_ue_3, n_hidden[3], tf.transpose(a_bs_ue, perm=[0, 2, 1, 3]),
                       hx_bs_3, access_BS_UE, transfer_function=activation_function, name='l4')

y_bs_pred0 = gnn_pe_layer(hx_bs_4, n_output, '', hx_ue_4, access_UE_BS, name='l6', is_transfer=False)
y_ue_pred0 = gnn_pe_layer(hx_ue_4, n_output, '', hx_bs_4, access_BS_UE,  name='l6', is_transfer=False)
