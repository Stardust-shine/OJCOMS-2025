...
trainfilename = 'Dataset/Train_' + str(n_marco) + 'MBS_' + str(nUE_marco) + 'UE_' + \
                                   str(n_pico) + 'PBS_' + str(nUE_pico) + 'UEA1.mat'
testfilename = 'Dataset/Test_' + str(n_marco) + 'MBS_' + str(nUE_marco) + 'UE_' + \
                                   str(n_pico) + 'PBS_' + str(nUE_pico) + 'UEA1.mat'
...
hx_bs_1 = gnn_pe_layer(x_bs, n_hidden[0], a_bs_ue, x_ue, access_UE_BS, transfer_function=tf.nn.leaky_relu, name='bs1')
...
hx_bs_2 = gnn_pe_layer(hx_bs_1, n_hidden[1], a_bs_ue, hx_ue_1, access_UE_BS, transfer_function=tf.nn.leaky_relu, name='bs2')
...
hx_bs_3 = gnn_pe_layer(hx_bs_2, n_hidden[2], a_bs_ue, hx_ue_2, access_UE_BS, transfer_function=tf.nn.leaky_relu, name='bs3')
...
hx_bs_4 = gnn_pe_layer(hx_bs_3, n_hidden[3], a_bs_ue, hx_ue_3, access_UE_BS, transfer_function=tf.nn.leaky_relu, name='bs4')
