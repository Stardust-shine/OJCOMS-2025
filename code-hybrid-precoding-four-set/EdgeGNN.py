...
from tf_utils import complex_multiply, edge_gnn_layer_1, complex_H, complex_modulus, complex_modulus_all


class EdgeGNN(object):
    ...
    def build_network(self):
        ...
        for l, h in enumerate(self.num_hidden[:]):
            edge_wrf, edge_h, edge_frf, edge_fbb = edge_gnn_layer_1(edge_wrf, edge_h, edge_frf, edge_fbb,
