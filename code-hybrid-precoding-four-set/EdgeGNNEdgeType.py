...
from tf_utils import flatten, fc, complex_multiply, edge_gnn_layer_edge_type, complex_H, complex_modulus, \
    complex_modulus_all


class EdgeGNNEdgeType(object):
    ...
    def build_network(self):
        ...
        for l, h in enumerate(self.num_hidden[:]):
            edge_wrf, edge_h, edge_frf, edge_fbb = edge_gnn_layer_edge_type(edge_wrf, edge_h, edge_frf, edge_fbb,
