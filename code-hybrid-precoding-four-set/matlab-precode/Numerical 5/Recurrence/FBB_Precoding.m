function [F_BB, Lamda, sigma_all] = FBB_Precoding(H,num_users,user_num_an,bs_num_an,num_user_stream,bs_num_rf,num_user_rf,W_RF_all,F_RF, P_max,sigma_dB)
...
% sigma_all = sigma_all;
sigma_all =(snr /(num_users*num_user_rf)) * sigma_all.^2;
[Lamda] = water_filling(sigma_all, num_users*num_user_rf,num_users,num_user_stream);

F_BB=F_BB*sqrt(diag(Lamda));
end

function [Lamda] = water_filling(sigma_all, P_max, num_users,num_user_stream)
