function [rate_all] = data_rate(num_test,num_users,user_num_an, num_user_stream,H_all,W_RF_all,F_RF_all,F_BB_all,sigma_dB)
...
for itr=1:num_test
    ...
    for user=1:num_users
        ...
        Q_k=(1/num_users)*w_k'*H_k*sum_inf_value*H_k'*w_k+sigma*w_k'*w_k;
        rate_k=log2(abs(det(eye(num_user_stream)+(1/num_users)*Q_k^(-1)*w_k'*H_k*v_k*v_k'*H_k'*w_k)));
        rate=rate+rate_k;
    end
