function [F_BB, Lamda, sigma_all] = FBB_Precoding(H,num_users,user_num_an,bs_num_an,num_user_stream,bs_num_rf,W_RF_all,F_RF, P_max,sigma_dB,norm_fbb_frf)
...
% sigma_all = sigma_all.^2/sigma;
sigma_all =P_max * sigma_all.^2/sigma;
[Lamda] = water_filling(sigma_all, norm_fbb_frf,num_users,num_user_stream);

F_BB = F_BB*sqrt(diag(Lamda));
end

function [Lamda] = water_filling(sigma_all, norm_fbb_frf, num_users,num_user_stream)
norm=norm_fbb_frf^2;
