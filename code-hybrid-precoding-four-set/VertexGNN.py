...
from tf_utils import flatten, fc, complex_multiply, vertex_gnn_layer, complex_H, complex_modulus, complex_modulus_all


class VertexGNN(object):
    ...
    def build_network(self):
        ...
        for l, h in enumerate(self.num_hidden[:]):
            user_rf, user_an, bs_rf, bs_an = vertex_gnn_layer(user_rf, user_an, bs_rf, bs_an,
